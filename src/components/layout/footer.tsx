        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Technology insights and company news, occasionally. No spam.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/60 pt-6 sm:flex-row">
          ...
          <div className="flex items-center gap-2">
            <Social href={siteConfig.social.linkedin} label="LinkedIn">
              <SvgIcon className="size-4" path={brandPaths.linkedin} />
            </Social>
            <Social href={siteConfig.social.facebook} label="Facebook">
              <SvgIcon className="size-4" path={brandPaths.facebook} />
            </Social>
            <Social href={siteConfig.social.instagram} label="Instagram">
              <SvgIcon className="size-4" path={brandPaths.instagram} />
            </Social>
            <Social href={siteConfig.social.twitter} label="X (Twitter)">
              <SvgIcon className="size-3.5" path={brandPaths.x} />
            </Social>
          </div>
        </div>
      </div>
...
function Social({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex size-9 items-center justify-center rounded-full border border-border bg-background text-muted-foreground transition-colors hover:border-brand-blue hover:text-brand-blue"
    >
      {children}
    </a>
  );
